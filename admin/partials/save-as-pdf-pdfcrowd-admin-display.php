...
<div class="wrap">
    ...
    <form method="post" id="save-as-pdf-pdfcrowd-options" name="save_as_pdf_pdfcrowd-options" action="options.php">
        ...
        $button_image = isset($options['button_image']) ? $options['button_image'] : 'pdf1.svg';
...
style="position: absolute; top: calc(50% - 12px); left: calc(50% - 12px);">';
        ...
        $button_text = isset($options['button_text']) ? $options['button_text'] : 'Save as PDF';
...
<a href="{{site_url}}">{{site}}</a></p>
        ...
        $email_subject = isset($options['email_subject']) ? $options['email_subject'] : '{{site}} - {{title}} PDF';
        $license_type = isset($options['license_type']) ? $options['license_type'] : 'demo';
        $no_margins = isset($options['no_margins']) ? $options['no_margins'] : '0';
        $output_format = isset($options['output_format']) ? $options['output_format'] : 'pdf';
        ...
        $rendering_mode = isset($options['rendering_mode']) ? $options['rendering_mode'] : 'viewport';
        $smart_scaling_mode = isset($options['smart_scaling_mode']) ? $options['smart_scaling_mode'] : 'viewport-fit';
        $username = isset($options['username']) ? $options['username'] : '';
        $version = isset($options['version']) ? $options['version'] : '2500';
        $viewport_height = isset($options['viewport_height']) ? $options['viewport_height'] : '15000';
        $viewport_width = isset($options['viewport_width']) ? $options['viewport_width'] : '993';
