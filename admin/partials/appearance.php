                ...
                <td id='save-as-pdf-pdfcrowd-images'>
                    <fieldset>
                        ...
                        <label for="save-as-pdf-pdfcrowd-pdf1.svg">
                            <input type="radio" id="save-as-pdf-pdfcrowd-pdf1.svg" name="save-as-pdf-pdfcrowd[button_image]" value="pdf1.svg" <?php checked( $button_image, "pdf1.svg" ); ?> />
                        ...
                        <label for="save-as-pdf-pdfcrowd-pdf2.svg">
                            <input type="radio" id="save-as-pdf-pdfcrowd-pdf2.svg" name="save-as-pdf-pdfcrowd[button_image]" value="pdf2.svg" <?php checked( $button_image, "pdf2.svg" ); ?> />
                        ...
                        <label for="save-as-pdf-pdfcrowd-pdf3.svg">
                            <input type="radio" id="save-as-pdf-pdfcrowd-pdf3.svg" name="save-as-pdf-pdfcrowd[button_image]" value="pdf3.svg" <?php checked( $button_image, "pdf3.svg" ); ?> />
                        ...
                        <label for="save-as-pdf-pdfcrowd-pdf4.svg">
                            <input type="radio" id="save-as-pdf-pdfcrowd-pdf4.svg" name="save-as-pdf-pdfcrowd[button_image]" value="pdf4.svg" <?php checked( $button_image, "pdf4.svg" ); ?> />
