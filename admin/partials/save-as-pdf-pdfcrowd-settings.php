            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($print_page_range); ?>"
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($page_numbering_offset); ?>"
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($content_area_width); ?>"
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($content_area_height); ?>"
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                    ...
                    <option value="mode2" <?php selected($css_page_rule_mode, 'mode2');?>>CSS @page rule is preferred.</option>
                        ...
                        <div class='save-as-pdf-pdfcrowd-devi'>
                            Shortcode and function parameter: "<strong>css_page_rule_mode</strong>"<br>Possible values: <ul><li>"default" - The Pdfcrowd API page settings are preferred.</li><li>"mode1" - The converter version 18.10 mode.</li><li>"mode2" - CSS @page rule is preferred.</li></ul>
                        </div>
                </td>
            </tr>
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
        ...
        <tbody>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                    ...
                    cols=60 autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"><?php echo(esc_html($header_html)); ?></textarea>
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                    ...
                    rows=5
                    <?php if(!current_user_can('unfiltered_html')) echo('readonly'); ?>
                    cols=60 autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"><?php echo(esc_html($footer_html)); ?></textarea>
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($exclude_header_on_pages); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($exclude_footer_on_pages); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($header_footer_scale_factor); ?>"
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($page_watermark_url); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($multipage_watermark); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($multipage_watermark_url); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($page_background); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($page_background_url); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($multipage_background); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($multipage_background_url); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($page_background_color); ?>"
                        placeholder="" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($viewport_height); ?>"
                        placeholder="768" autocomplete="off" />
                        <div class="save-as-pdf-pdfcrowd-description">
                          <div>
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                    ...
                    <option value="outlines" <?php selected($page_mode, 'outlines');?>>Document outline is visible.</option>
                        ...
                        <div class='save-as-pdf-pdfcrowd-devi'>
                            Shortcode and function parameter: "<strong>page_mode</strong>"<br>Possible values: <ul><li>"full-screen" - Full-screen mode.</li><li>"thumbnails" - Thumbnail images are visible.</li><li>"outlines" - Document outline is visible.</li></ul>
                        </div>
                </td>
            </tr>
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
            ...
            <tr class="save-as-pdf-pdfcrowd-set-group save-as-pdf-pdfcrowd-adv-input"
                ...
                <td>
                      <input
                        ...
                        value="<?php echo($contents_matrix); ?>"
